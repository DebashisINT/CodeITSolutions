package com.breezefieldsalescodeit.features.logoutsync.presentation
...
import com.breezefieldsalescodeit.app.AppDatabase
...
import com.breezefieldsalescodeit.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldsalescodeit.features.billing.api.AddBillingRepoProvider
import com.breezefieldsalescodeit.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldsalescodeit.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldsalescodeit.features.document.model.AddEditDocumentInputParams
import com.breezefieldsalescodeit.features.document.model.DocumentAttachmentModel
...
import com.breezefieldsalescodeit.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezefieldsalescodeit.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldsalescodeit.features.orderhistory.model.*
...
import com.breezefieldsalescodeit.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldsalescodeit.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldsalescodeit.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldsalescodeit.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldsalescodeit.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldsalescodeit.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldsalescodeit.mappackage.SendBrod
import com.breezefieldsalescodeit.widgets.AppCustomTextView
import com.breezefieldsalescodeit.MonitorService
import com.breezefieldsalescodeit.MySingleton
...
import com.breezefieldsalescodeit.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldsalescodeit.features.login.model.GetConcurrentUserResponse
import com.breezefieldsalescodeit.features.login.model.WhatsappApiData
import com.breezefieldsalescodeit.features.orderITC.SyncOrd
import com.breezefieldsalescodeit.features.orderITC.SyncOrdProductL
import com.breezefieldsalescodeit.features.performance.model.Gps_status_list
import com.breezefieldsalescodeit.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldsalescodeit.features.returnsOrder.ReturnProductList
import com.breezefieldsalescodeit.features.returnsOrder.ReturnRequest
import com.breezefieldsalescodeit.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalescodeitlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalescodeitlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalescodeitlogsample/log.zip").path);
