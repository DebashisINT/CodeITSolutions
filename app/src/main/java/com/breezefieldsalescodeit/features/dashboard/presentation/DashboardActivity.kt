package com.breezefieldsalescodeit.features.dashboard.presentation
...
import com.breezefieldsalescodeit.*
import com.breezefieldsalescodeit.R
import com.breezefieldsalescodeit.app.*
import com.breezefieldsalescodeit.app.NewFileUtils.browseDocuments
import com.breezefieldsalescodeit.app.NewFileUtils.browsePDFDocuments
import com.breezefieldsalescodeit.app.NewFileUtils.getExtension
import com.breezefieldsalescodeit.app.domain.*
import com.breezefieldsalescodeit.app.types.DashboardType
import com.breezefieldsalescodeit.app.types.FragType
import com.breezefieldsalescodeit.app.types.TopBarConfig
import com.breezefieldsalescodeit.app.uiaction.DisplayAlert
import com.breezefieldsalescodeit.app.utils.*
import com.breezefieldsalescodeit.app.utils.AppUtils.Companion.isProfile
import com.breezefieldsalescodeit.base.BaseResponse
import com.breezefieldsalescodeit.base.presentation.BaseActivity
import com.breezefieldsalescodeit.base.presentation.BaseFragment
import com.breezefieldsalescodeit.features.NewQuotation.*
import com.breezefieldsalescodeit.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldsalescodeit.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldsalescodeit.features.SearchLocation.SearchLocationFragment
import com.breezefieldsalescodeit.features.SearchLocation.locationInfoModel
import com.breezefieldsalescodeit.features.TA.ViewAllTAListFragment
import com.breezefieldsalescodeit.features.achievement.AchievementFragment
import com.breezefieldsalescodeit.features.activities.presentation.*
import com.breezefieldsalescodeit.features.addAttendence.*
import com.breezefieldsalescodeit.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldsalescodeit.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldsalescodeit.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldsalescodeit.features.addAttendence.model.GetReportToResponse
import com.breezefieldsalescodeit.features.addAttendence.model.Leave_list_Response
import com.breezefieldsalescodeit.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldsalescodeit.features.addshop.presentation.AddShopFragment
import com.breezefieldsalescodeit.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldsalescodeit.features.addshop.presentation.ScanImageFragment
import com.breezefieldsalescodeit.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldsalescodeit.features.alarm.model.AlarmData
import com.breezefieldsalescodeit.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldsalescodeit.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldsalescodeit.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldsalescodeit.features.alarm.presetation.VisitReportFragment
import com.breezefieldsalescodeit.features.attendance.AttendanceFragment
import com.breezefieldsalescodeit.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldsalescodeit.features.attendance.model.AttendanceRequest
import com.breezefieldsalescodeit.features.attendance.model.AttendanceResponse
import com.breezefieldsalescodeit.features.averageshop.presentation.AverageShopFragment
import com.breezefieldsalescodeit.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldsalescodeit.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldsalescodeit.features.beatCustom.TeamBeatListFragment
import com.breezefieldsalescodeit.features.billing.presentation.AddBillingFragment
import com.breezefieldsalescodeit.features.billing.presentation.BillingDetailsFragment
import com.breezefieldsalescodeit.features.billing.presentation.BillingListFragment
import com.breezefieldsalescodeit.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldsalescodeit.features.chat.model.ChatListDataModel
import com.breezefieldsalescodeit.features.chat.model.ChatUserDataModel
import com.breezefieldsalescodeit.features.chat.model.GroupUserDataModel
import com.breezefieldsalescodeit.features.chat.presentation.*
import com.breezefieldsalescodeit.features.chatbot.presentation.ChatBotFragment
import com.breezefieldsalescodeit.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldsalescodeit.features.chatbot.presentation.ReportsFragment
import com.breezefieldsalescodeit.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldsalescodeit.features.commondialog.presentation.CommonDialog
import com.breezefieldsalescodeit.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldsalescodeit.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldsalescodeit.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldsalescodeit.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldsalescodeit.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldsalescodeit.features.contacts.ActivityDtlsFrag
import com.breezefieldsalescodeit.features.contacts.ContactDtls
import com.breezefieldsalescodeit.features.contacts.ContactGr
import com.breezefieldsalescodeit.features.contacts.ContactsAddFrag
import com.breezefieldsalescodeit.features.contacts.ContactsFrag
import com.breezefieldsalescodeit.features.contacts.SchedulerViewFrag
import com.breezefieldsalescodeit.features.contacts.SchedulerAddFormFrag
import com.breezefieldsalescodeit.features.contacts.TemplateAddFrag
import com.breezefieldsalescodeit.features.contacts.TemplateViewFrag
import com.breezefieldsalescodeit.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldsalescodeit.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldsalescodeit.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldsalescodeit.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldsalescodeit.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldsalescodeit.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldsalescodeit.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldsalescodeit.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldsalescodeit.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldsalescodeit.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldsalescodeit.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldsalescodeit.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldsalescodeit.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldsalescodeit.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldsalescodeit.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldsalescodeit.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldsalescodeit.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldsalescodeit.features.document.presentation.DocumentListFragment
import com.breezefieldsalescodeit.features.document.presentation.DocumentTypeListFragment
import com.breezefieldsalescodeit.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldsalescodeit.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldsalescodeit.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldsalescodeit.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldsalescodeit.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldsalescodeit.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldsalescodeit.features.home.presentation.HomeFragment
import com.breezefieldsalescodeit.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldsalescodeit.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldsalescodeit.features.know_your_state.KnowYourStateFragment
import com.breezefieldsalescodeit.features.lead.LeadFrag
import com.breezefieldsalescodeit.features.lead.ViewLeadFrag
import com.breezefieldsalescodeit.features.leaderboard.LeaderBoardFrag
import com.breezefieldsalescodeit.features.leaveapplynew.LeaveHome
import com.breezefieldsalescodeit.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldsalescodeit.features.localshops.LocalShopListFragment
import com.breezefieldsalescodeit.features.localshops.LocalShopListMapFragment
import com.breezefieldsalescodeit.features.localshops.NearByShopsMapFragment
import com.breezefieldsalescodeit.features.location.*
import com.breezefieldsalescodeit.features.location.api.LocationRepoProvider
import com.breezefieldsalescodeit.features.location.model.*
import com.breezefieldsalescodeit.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldsalescodeit.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldsalescodeit.features.login.ShopFeedbackEntity
import com.breezefieldsalescodeit.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldsalescodeit.features.login.presentation.LoginActivity
import com.breezefieldsalescodeit.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldsalescodeit.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldsalescodeit.features.marketAssist.MarketAssistTabFrag
import com.breezefieldsalescodeit.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldsalescodeit.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldsalescodeit.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldsalescodeit.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldsalescodeit.features.member.MapViewForTeamFrag
import com.breezefieldsalescodeit.features.member.model.TeamLocDataModel
import com.breezefieldsalescodeit.features.member.model.TeamShopListDataModel
import com.breezefieldsalescodeit.features.member.presentation.*
import com.breezefieldsalescodeit.features.menuBeat.MenuBeatFrag
import com.breezefieldsalescodeit.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldsalescodeit.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldsalescodeit.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldsalescodeit.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldsalescodeit.features.myjobs.model.CustomerDataModel
import com.breezefieldsalescodeit.features.myjobs.presentation.*
import com.breezefieldsalescodeit.features.myorder.presentation.MyOrderListFragment
import com.breezefieldsalescodeit.features.myprofile.presentation.MyProfileFragment
import com.breezefieldsalescodeit.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefieldsalescodeit.features.nearbyshops.model.ShopData
import com.breezefieldsalescodeit.features.nearbyshops.model.ShopListResponse
import com.breezefieldsalescodeit.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldsalescodeit.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldsalescodeit.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldsalescodeit.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldsalescodeit.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldsalescodeit.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldsalescodeit.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldsalescodeit.features.newcollection.CollectionShopListFragment
import com.breezefieldsalescodeit.features.newcollection.NewCollectionListFragment
import com.breezefieldsalescodeit.features.newcollectionreport.*
import com.breezefieldsalescodeit.features.notification.NotificationFragment
import com.breezefieldsalescodeit.features.orderITC.CartListFrag
import com.breezefieldsalescodeit.features.orderITC.OrderListFrag
import com.breezefieldsalescodeit.features.orderITC.ProductListFrag
import com.breezefieldsalescodeit.features.orderITC.ViewNewOrdHisAllFrag
import com.breezefieldsalescodeit.features.orderITC.ViewNewOrdHistoryFrag
import com.breezefieldsalescodeit.features.orderITC.ViewOrdDtls
import com.breezefieldsalescodeit.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldsalescodeit.features.orderList.NewOrderListFragment
import com.breezefieldsalescodeit.features.orderList.OrderListFragment
import com.breezefieldsalescodeit.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldsalescodeit.features.orderhistory.ActivityMapFragment
import com.breezefieldsalescodeit.features.orderhistory.OrderhistoryFragment
import com.breezefieldsalescodeit.features.orderhistory.TimeLineFragment
import com.breezefieldsalescodeit.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezefieldsalescodeit.features.orderhistory.model.LocationData
import com.breezefieldsalescodeit.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldsalescodeit.features.performance.GpsStatusFragment
import com.breezefieldsalescodeit.features.performance.PerformanceFragment
import com.breezefieldsalescodeit.features.performance.api.UpdateGpsStatusRepoProvider
...
import com.breezefieldsalescodeit.features.performanceAPP.PerformanceAppFragment
import com.breezefieldsalescodeit.features.performanceAPP.allPerformanceFrag
import com.breezefieldsalescodeit.features.permissionList.ViewPermissionFragment
import com.breezefieldsalescodeit.features.photoReg.*
import com.breezefieldsalescodeit.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldsalescodeit.features.quotation.presentation.*
import com.breezefieldsalescodeit.features.reimbursement.presentation.*
import com.breezefieldsalescodeit.features.report.presentation.*
import com.breezefieldsalescodeit.features.returnsOrder.*
import com.breezefieldsalescodeit.features.settings.presentation.SettingsFragment
import com.breezefieldsalescodeit.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldsalescodeit.features.shopdetail.presentation.*
import com.breezefieldsalescodeit.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalescodeit.features.stock.StockDetailsFragment
import com.breezefieldsalescodeit.features.stock.StockListFragment
import com.breezefieldsalescodeit.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldsalescodeit.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldsalescodeit.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldsalescodeit.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldsalescodeit.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldsalescodeit.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldsalescodeit.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldsalescodeit.features.survey.SurveyFrag
import com.breezefieldsalescodeit.features.survey.SurveyViewDtlsFrag
import com.breezefieldsalescodeit.features.survey.SurveyViewFrag
import com.breezefieldsalescodeit.features.task.presentation.AddTaskFragment
import com.breezefieldsalescodeit.features.task.presentation.CalenderTaskFragment
import com.breezefieldsalescodeit.features.task.presentation.EditTaskFragment
import com.breezefieldsalescodeit.features.task.presentation.TaskListFragment
import com.breezefieldsalescodeit.features.taskManagement.TaskManagementFrag
import com.breezefieldsalescodeit.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldsalescodeit.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldsalescodeit.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldsalescodeit.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldsalescodeit.features.viewAllOrder.CartFragment
import com.breezefieldsalescodeit.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldsalescodeit.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldsalescodeit.features.viewAllOrder.ViewCartFragment
import com.breezefieldsalescodeit.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldsalescodeit.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldsalescodeit.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldsalescodeit.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldsalescodeit.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldsalescodeit.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldsalescodeit.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldsalescodeit.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldsalescodeit.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldsalescodeit.features.viewPPDDStock.ViewStockFragment
import com.breezefieldsalescodeit.features.weather.presentation.WeatherFragment
import com.breezefieldsalescodeit.mappackage.MapActivity
import com.breezefieldsalescodeit.mappackage.MapActivityWithoutPath
import com.breezefieldsalescodeit.mappackage.SendBrod
import com.breezefieldsalescodeit.widgets.AppCustomEditText
import com.breezefieldsalescodeit.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldsalescodeitlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalescodeitlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezefieldsalescodeit/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalescodeitlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalescodeitlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalescodeitlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalescodeitlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
