package com.breezefieldsalescodeit.features.reimbursement.presentation
...
import com.breezefieldsalescodeit.app.utils.AppUtils.Companion.convertFromRightToReverseFormatWithTime
import com.breezefieldsalescodeit.app.utils.AppUtils.Companion.getFormattedDateForApi
import com.breezefieldsalescodeit.app.utils.AppUtils.Companion.hideSoftKeyboard
import com.breezefieldsalescodeit.app.utils.CustomTextWatcher
import com.breezefieldsalescodeit.app.utils.PermissionUtils
import com.breezefieldsalescodeit.app.utils.ProcessImageUtils_v1
...
import com.breezefieldsalescodeit.features.reimbursement.api.ReimbursementConfigRepoProvider
import com.breezefieldsalescodeit.features.reimbursement.api.applyapi.ApplyReimbursementRepoProvider
import com.breezefieldsalescodeit.features.reimbursement.api.configfetchapi.ReimbursementConfigFetchRepoProvider
import com.breezefieldsalescodeit.features.reimbursement.api.reimbursement_list_api.ReimbursementListRepoProvider
import com.breezefieldsalescodeit.features.reimbursement.api.reimbursementshopapi.ReimbursementShopRepoProvider
import com.breezefieldsalescodeit.features.reimbursement.model.*
import com.breezefieldsalescodeit.features.reimbursement.model.reimbursement_shop.ReimbursementShopDataModel
import com.breezefieldsalescodeit.features.reimbursement.model.reimbursement_shop.ReimbursementShopResponseModel
import com.breezefieldsalescodeit.features.reimbursement.model.reimbursementlist.ReimbursementListDataModel
import com.breezefieldsalescodeit.features.reimbursement.model.reimbursementlist.ReimbursementListDetailsModel
import com.breezefieldsalescodeit.features.reimbursement.model.reimbursementlist.ReimbursementListResponseModel
...
class ReimbursementFragment : BaseFragment(), DateAdapter.onPetSelectedListener, View.OnClickListener, TabLayout.OnTabSelectedListener, RadioGroup.OnCheckedChangeListener {
    ...
    private fun initView(view: View) {
        ...
        //attachbreezefieldsalescodeitData()
...
//                            XLog.d("ReimbursementConfigApiResponse ERROR: " + error.localizedMessage)
    ...
    private fun attachbreezefieldsalescodeitData() {
